...
class TestNotifyDiscord(unittest.TestCase):
    ...
    def test_missing_github_event_name(self):
        ...
        with patch("os.getenv") as mock_getenv, \
             patch("builtins.open", mock_open(read_data='{"user1": "123456789"}')):
            ...
            self.assertIn("GITHUB_EVENT_NAME environment variable is not set", str(context.exception))
    ...
    def test_missing_github_event_path(self):
        ...
        with patch("os.getenv") as mock_getenv, \
            ...
            self.assertIn("GITHUB_EVENT_PATH environment variable is not set", str(context.exception))
    ...
    def test_missing_discord_webhook_url(self):
        ...
        with patch("os.getenv") as mock_getenv, \
            ...
            self.assertIn("DISCORD_WEBHOOK_URL environment variable is missing or empty", str(context.exception))
    ...
    def test_post_to_discord_function_with_missing_webhook(self, mock_post):
        ...
        with patch("os.getenv") as mock_getenv, \
            ...
            with patch.object(notify_discord, 'webhook_url', None):
                ...
                self.assertIn("DISCORD_WEBHOOK_URL environment variable is not set", str(context.exception))
