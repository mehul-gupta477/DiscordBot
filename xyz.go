...
- Enhanced comment (if needed) - DO NOT include "**Validation**:" or other validation metadata in enhanced_comment
  ...
  "comments": [
    {
      ...
      "enhanced_comment": "Enhanced comment with correct information...",
